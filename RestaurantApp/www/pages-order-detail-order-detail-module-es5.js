    ...
    var OrderDetailPage = /*#__PURE__*/function () {
      ...
      _createClass(OrderDetailPage, [{
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 2:
                          ...
                          console.log(distance); // if (element.current === 'active' && element.status === 'active') {
                ...
                if (element && element.selectedItem && element.selectedItem.length > 0) {
                  ...
                  element.selectedItem.forEach(function (subItems, j) {
                    ...
                    subItems.item.forEach(function (addons, k) {
                      subDatas.push('<div style="display:flex;flex-direction:row;justify-content:space-between"> <p style="font-weight:bold;color:gray;margin:0px;"> -' + addons.name + '</p> <p style="font-weight:bold;color:gray;margin:0px;">' + _this5.getCurrency() + ' ' + addons.value + '</p> </div> ');
                    });
                    var subOrders = subDatas.join('');
                    var info = items.replace('##ITEWS##', subOrders);

                    _this5.orderString.push(info);
                  });
                  console.log('news --->>', items);
                } else {
                  var _items = '<div style="border-bottom:1px dashed lightgray;display:flex;flex-direction:row;justify-content:space-between"> <p style="font-weight:bold"> ' + element.name + ' X ' + element.quantiy + ' </p> <p style="font-weight:bold">' + element.price + _this5.getCurrency() + '</p> </div>';

                  _this5.orderString.push(_items);
                }
              });
        ...
        value: function printOrder() {
          ...
          var content = '<div style="padding: 20px;display: flex;flex-direction: column;"> <img src="assets/icon.png" style="text-align: center; height: 100px;width: 100px;" alt=""> <h2 style="text-align: center;">Foodies Order Summary</h2> <p style="float: left;margin:0px;"><b>' + this.id + '</b></p> <p style="float: left;margin:0px;"><b>' + this.restName + '</b></p> <p style="float: left;margin:0px;"><b>' + this.userName + '</b></p> <p style="float: left;margin:0px;">' + this.time + ' </p> <p style="font-weight: bold;margin:0px;">' + this.util.translate('ITEMS') + '</p> ' + order + ' <p style="border-bottom: 1px solid black;margin:0px;"><span style="float: left;font-weight: bold;">' + this.util.translate('SubTotal') + '</span> <span style="float: right;font-weight: bold;">' + this.getCurrency() + this.total + '</span> <p style="border-bottom: 1px solid black;"><span style="float: left;font-weight: bold;">' + this.util.translate('Delivery Charge') + '</span> <span style="float: right;font-weight: bold;">' + this.getCurrency() + '5</span> </p> <p style="border-bottom: 1px solid black;"><span style="float: left;font-weight: bold;">' + this.util.translate('Service Tax') + '</span> <span style="float: right;font-weight: bold;">' + this.getCurrency() + this.serviceTax + '</span> </p> <p style="border-bottom: 1px solid black;"><span style="float: left;font-weight: bold;">' + this.util.translate('Total') + '</span> <span style="float: right;font-weight: bold;">' + this.getCurrency() + this.grandTotal + '</span> </p> <h1 style="text-align: center;text-transform: uppercase;">' + this.paid + '</h1> </div>';
