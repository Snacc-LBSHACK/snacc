...
AnalyticsPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let AnalyticsPage = class AnalyticsPage {
    constructor(api, util, router) {
        ...
        this.pieChartLabels = [this.util.translate('New Orders'), this.util.translate('Completed'),
    ...
    changeMode() {
        ...
        if (this.report === 'now') {
            ...
            const currentMonth = moment__WEBPACK_IMPORTED_MODULE_5__().format('MM');
            ...
            if (this.allOrders.length) {
                ...
                this.allOrders.forEach(element => {
                    let orderMonth = moment__WEBPACK_IMPORTED_MODULE_5__(element.time).format('MM');
...
AnalyticsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./analytics.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/analytics/analytics.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./analytics.page.scss */ "./src/app/pages/analytics/analytics.page.scss")).default]
    }),
